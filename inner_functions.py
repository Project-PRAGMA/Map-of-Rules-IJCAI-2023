...
def test_priceability(election, feature_params):
    ...
    return int(_check_priceability_gurobi(profile, committee))


def test_core(election, feature_params):
    ...
    return int(_check_core_gurobi(profile, committee, feature_params['committee_size']))